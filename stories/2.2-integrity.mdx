...
# hc_zome_notifications_provider_integrity
...
[Read the documentation for the types available from this zome](https://docs.rs/hc_zome_notifications_provider_integrity).
